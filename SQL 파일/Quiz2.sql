...
--     소속부서 관리자 직원이름을 조회하기
SELECT A.EMPLOYEE_ID, A.FIRST_NAME, A.JOB_ID, B.DEPARTMENT_ID, B.DEPARTMENT_NAME, B.MANAGER_ID, A2.FIRST_NAME
