...
<%
	...
	String password = StringUtil.nullToBlank(request.getParameter("userpassword"));
	...
	// 아이디에 해당하는 사용자 정보도 존재하고, 비밀번호도 일치하는 경우에만 아래 수행문은 실행됨
	
	// 1. 우리 사이트에 가입한 회원이고, 그 회원이 직접 로그인한 것이 맞음.
	// 2. 회원이 다른 서비스를 사용하는 동안 추가적인 회원정보 입력없이 모든 서비스를 
	//    사용하도록 할 것임
