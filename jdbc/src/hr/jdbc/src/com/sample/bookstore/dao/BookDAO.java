...
public class BookDAO {
	...
	public List<Book> getAllBooks() throws Exception {
		...
		while(rs.next()) {
			...
			book.setRegisterDate(rs.getDate("book_registered_date"));
	 ...
	 * @return 조회된 책 정보가 없으면 빈 List객체가 반환된다.
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public List<Book> getBookByGenre(String genre) throws Exception {
		List<Book> books = new ArrayList<Book>();
	...
	/**
	 * 지정된 책번호에 해당하는 책 정보를 데이터베이스에서 삭제합니다.
