...
public class StringDemo1 {
	...
	public static void main(String[] args) {
		...
		// boolean equals(Object other) : 자신과 other로 전달받은 문자열의 내용을 비교해서 그 결과를 반환한다.
		// boolean equalsIgnoreCase(String other) : 대소문자를 구분하지 않고 비교한다.
		...
		// String substring(int begin, int end) : 지정된 범위 내의 문자열이 포함된 새로운 문자열을 반환한다.
		...
		System.out.println("3번째부터 9번째까지를 포함하는 문자열 : " + s2);
		// 공백도 하나의 문자로 쳐서 공백도 개수에 포함된다.
		...
		// String replace(CharSequence old, CharSequence nw) : 지정된 문자열(odl)을 새문자열(pdl)을 새로운
		// String replaceAll(String regexp, String replacement) : 문자열에서 지정된 정규표현식과 
		...
		// int indexOf(String str) : 문자열에 지정된 문자열이 있으면 그 위치를 반환한다. 없으면 -1을 반환한다.
		...
		// Strint trim() : 문자열에서 불필요한 좌우공백을 제거한 새로운 문자열을 반환한다.
		...
		int num1 = 123456;
		int num2 = 7890;
		String s8 = String.valueOf(123456);
		String s9 = String.valueOf(123456);
