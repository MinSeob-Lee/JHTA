...
public class StringDemo4 {
	...
	public static void main(String[] args) {
		...
		// StringBuilder replace(int start, int end, String str) : 지정된 범위의 문자열을 새 문자열로
		// 변경한다.
		...
		// StringBuilder와 StringBuffer는 메소드 체이닝을 지원한다.
		String resultText = sb1.append("이름:").append(name).append(", 전화번호:").append(tel).toString();
	}
}
