...
<div class="container">
	...
	<div class="row">
		<div class="col-12">
			...
			<dl>
				<dt>번호</dt><dd>${x.no }</dd>
				<dt>제목</dt><dd>${x.title }</dd>
				<dt>저자</dt><dd>${x.writer }</dd>
				<dt>가격</dt><dd>${x.price }</dd>
				<dt>할인률</dt><dd>${x.discountRate }</dd>
				<dt>구매가격</dt><dd>${x.discountPrice }</dd>
				<dt>재고</dt><dd>${x.stock }</dd>
				<dt>절판여부</dt><dd>${x.soldOut }</dd>
				<dt>출판일</dt><dd>${x.pubDate }</dd>
			</dl>
