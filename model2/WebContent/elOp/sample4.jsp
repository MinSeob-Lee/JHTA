			...
			<form>
				<div class="form-group">
					...
					<select name="cat">
						...
						<option value="foreign" ${param.category eq 'foreign' ? 'selected' : '' }>해외도서</option>
						<option value="ebook" ${param.category eq 'ebook' ? 'selected' : '' }>전자도서</option>
	...
	<div class="row">
		<div class="col-12">
			<ul class="list-grouop">
				...
				<li class="list-group-item ${param.category eq 'foreign' ? 'active' : '' }"><a href="sample4.jsp?category=foreign">해외도서</a></li>
				<li class="list-group-item ${param.category eq 'ebook' ? 'active' : '' }"><a href="sample4.jsp?category=ebook">전자도서</a></li>
