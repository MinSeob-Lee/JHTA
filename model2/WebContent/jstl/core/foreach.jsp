		...
		<div class="col-12">
			<ul class="pagination">
				<c:choose>
					...
					<c:otherwise>
						<li class="page-item disabled"><a class="page-link" href="foreach.jsp?pageno=${param.pageno - 1 }">이전</a></li>						
					</c:otherwise>
				</c:choose>
				...
				<c:choose>
					...
					<c:otherwise>
						<li class="page-item disabled"><a class="page-link" href="foreach.jsp?pageno=${param.pageno + 1 }">다음</a></li>
					</c:otherwise>
				</c:choose>
			</ul>
		</div>
