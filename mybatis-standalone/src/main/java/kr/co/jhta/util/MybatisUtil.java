...
public class MybatisUtil {
	 ...
	 * mybatis의 주요 API
	 * 		- SqlSession
	 * 		Object 매퍼파일에 정의된 SQL문을 실행하는 객체다.
	 ...
	 * 		List selectList(Sting id, Object parameter)
	 * 		void close()
	 * 		void commit()
	 * 		void rollback()
	 * 		주의사항) 쿼리를 한 번 실행할 때마다 SqlSessionFactory로부터 새로운 SqlSession객체를 획득해서 사용하고, 폐기한다.
	 * 			
	 * 		- SqlSessionFactory
	 ...
	 * 			mybatis 환결설정 정보(/src/main/resources/mybatis/mybatis-config.xml)를 이용해서 SqlSessionFactory객체를 생성한다.
