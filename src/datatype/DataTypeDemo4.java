...
public class DataTypeDemo4 {
	...
	public static void main(String[] args) {
		...
		// 논리값 리터럴		true	false
		// 정수 리터럴			1	10	0	-3	1_000_000 1000000000L 100000000000l
...
//		int num6 = 3000000000;		// int값의 범위를 초과하기 때문에 오류
		long num7 = 3000000000L;	// int값의 범위를 초과하는 값읕 long에 대입할 떄 리터럴에 L을 붙인다.
		...
		// 실수값 다루기
		float value1 = 3.14f;		// 실수 리터럴은 double타입으로 판단한다. float타입으로 판단하도록 f를 붙인다.
		double value2 = 3.14;
